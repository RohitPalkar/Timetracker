...
export const DEMO_PROJECTS: Project[] = [
  {
    ...
    progress: 62,
    ownerId: 'user-rohit',
    managerIds: ['user-rohit', 'user-aditi'],
  ...
  },
  {
    ...
    type: 'product',
    description:
      'Unified payments and digital banking platform delivered through federated delivery teams, each running an independent sub-project with its own manager, budget, and delivery cadence.',
    status: 'active',
    health: 'on_track',
    progress: 38,
    ownerId: 'user-rohit',
    ...
    budget: 1800000,
    spent: 640000,
    tags: ['payments', 'federated', 'fintech', 'multi-delivery'],
    updatedAt: daysAgo(0),
    hasSubProjects: true,
  },
]
...
const MILESTONE_SEED: Array<{
  ...
  { projectId: 'prj-utec', title: 'Federation model & onboarding', startDaysAgo: 90, status: 'completed' },
  { projectId: 'prj-utec', title: 'EFA core flows', startDaysAgo: 40, status: 'in_progress' },
  { projectId: 'prj-utec', title: 'UTLITE rollout', startDaysAgo: -45, status: 'planned' },
]
